...
public abstract class RadiatedWaterFluid extends FlowableFluid implements IModID {
    @Override
    public String getID() {
        return "radiated_water";
    }
    ...
    public static class Flowing extends RadiatedWaterFluid {
        @Override
    ...
    public static class Still extends RadiatedWaterFluid {
        @Override
        public int getLevel(FluidState fluidState) {
            return 8;
        }
