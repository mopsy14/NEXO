package mopsy.productions.nexo.screen.press;
...
public class PressScreen extends HandledScreen<PressScreenHandler> {
    private static final Identifier TEXTURE = Identifier.of(modid, "textures/gui/press.png");
    ...
    protected void drawBackground(DrawContext context, float delta, int mouseX, int mouseY) {
        ...
        renderEnergyTooltipPredicate = ScreenUtils.renderEnergyStorage(this, context, x+147, y+11, getPower(), PressEntity.POWER_CAPACITY);
    ...
    private void renderProgress(DrawContext context, int x, int y){
        if(handler.isCrafting()){
            ...
            context.drawTexture(RenderLayer::getGuiTextured,TEXTURE, x+80, y+16, 192, 0, 16, handler.getScaledProgress(),256,256);
        }
    }
