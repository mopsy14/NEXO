...
public class SteamTurbineScreen extends HandledScreen<SteamTurbineScreenHandler>{
    private static final Identifier TEXTURE = Identifier.of(modid, "textures/gui/steam_turbine.png");
    ...
    public SteamTurbineScreen(SteamTurbineScreenHandler handler, PlayerInventory inventory, Text title) {
    ...
    protected void drawBackground(DrawContext context, float delta, int mouseX, int mouseY) {
        ...
        renderFluidStorageTooltipPredicate2 = ScreenUtils.renderSmallFluidStorage(this, context, x+67, y+19, getFluidAmount(1), getMaxFluidAmount(1), getFluidType(1));
        renderEnergyTooltipPredicate = ScreenUtils.renderEnergyStorage(this, context, x+152, y+11, getPower(), SteamTurbineEntity.POWER_CAPACITY);
    }
