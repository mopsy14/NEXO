...
public class HazmatLeggings extends ArmorItem implements IModID, IArmorRadiationProtection {
    ...
    public HazmatLeggings() {
        super(ModdedArmorMaterials.HAZMAT, EquipmentSlot.LEGS, new Settings());ItemGroupEvents.modifyEntriesEvent(CREATIVE_TAB_KEY).register(entries -> entries.add(this));
    }
