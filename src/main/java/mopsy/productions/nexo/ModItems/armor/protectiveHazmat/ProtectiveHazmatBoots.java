...
public class ProtectiveHazmatBoots extends ArmorItem implements IModID, IArmorRadiationProtection {
    ...
    public ProtectiveHazmatBoots() {
        super(ModdedArmorMaterials.PROTECTIVE_HAZMAT, EquipmentType.BOOTS, new Settings()
                .registryKey(RegistryKey.of(RegistryKeys.ITEM, Identifier.of(modid,"protective_hazmat_boots"))));
