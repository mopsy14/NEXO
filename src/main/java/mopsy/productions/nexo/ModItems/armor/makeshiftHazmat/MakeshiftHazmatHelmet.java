...
public class MakeshiftHazmatHelmet extends ArmorItem implements IModID, IArmorRadiationProtection {
    ...
    public MakeshiftHazmatHelmet() {
        super(ModdedArmorMaterials.MAKESHIFT_HAZMAT, EquipmentType.HELMET, new Settings()
                .registryKey(RegistryKey.of(RegistryKeys.ITEM, Identifier.of(modid,"makeshift_hazmat_helmet"))));
