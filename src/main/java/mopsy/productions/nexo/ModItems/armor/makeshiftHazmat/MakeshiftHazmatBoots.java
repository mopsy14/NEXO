...
public class MakeshiftHazmatBoots extends ArmorItem implements IModID, IArmorRadiationProtection {
    ...
    public MakeshiftHazmatBoots() {
        super(ModdedArmorMaterials.MAKESHIFT_HAZMAT, EquipmentType.BOOTS, new Settings()
                .registryKey(RegistryKey.of(RegistryKeys.ITEM, Identifier.of(modid,"makeshift_hazmat_boots"))));
