...
public class OilRefineryEntity extends BlockEntity implements ExtendedScreenHandlerFactory, SidedInventory, IFluidStorage, IBlockEntityRecipeCompat {
    public static String ID = "oil_refinery";
    ...
    public OilRefineryEntity(BlockPos pos, BlockState state) {
        super(ModdedBlockEntities.OIL_REFINERY, pos, state);
        ...
        this.propertyDelegate = new PropertyDelegate() {
            ...
            public int get(int index) {
                switch (index){
                    case 0: return OilRefineryEntity.this.coreHeat;
                    case 1: return OilRefineryEntity.this.waterHeat;
                    case 2: return OilRefineryEntity.this.active;
                    default: return 0;
                }
            }
            ...
            public void set(int index, int value) {
                switch (index){
                    case 0: OilRefineryEntity.this.coreHeat = value; break;
                    case 1: OilRefineryEntity.this.waterHeat = value; break;
                    case 2: OilRefineryEntity.this.active = value; break;
                }
            }
    ...
    public Text getDisplayName() {
        return Text.literal("Oil Refinery");
    }
    ...
    public static void tick(World world, BlockPos blockPos, BlockState blockState, OilRefineryEntity entity) {
    ...
    private static boolean tryFabricTransactions(OilRefineryEntity entity) {
    ...
    private static boolean tryTransactions(OilRefineryEntity entity){
    ...
    private static void sendFluidUpdate(OilRefineryEntity entity){
