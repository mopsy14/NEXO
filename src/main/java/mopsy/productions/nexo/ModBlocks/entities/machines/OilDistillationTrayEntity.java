...
public class OilDistillationTrayEntity extends BlockEntity implements ExtendedScreenHandlerFactory, SidedInventory, IFluidStorage, IBlockEntityRecipeCompat {
    public static String ID = "oil_distillation_tray";
    ...
    public OilDistillationTrayEntity(BlockPos pos, BlockState state) {
        super(ModdedBlockEntities.SMALL_REACTOR, pos, state);
        fluidStorages.add(new NTFluidStorage(32* FluidConstants.BUCKET ,this, false , 0));
        this.propertyDelegate = new PropertyDelegate() {
            @Override
            public int get(int index) {
                switch (index){
                    case 0: return OilDistillationTrayEntity.this.coreHeat;
                    case 1: return OilDistillationTrayEntity.this.waterHeat;
                    case 2: return OilDistillationTrayEntity.this.active;
                    default: return 0;
                }
            }
            ...
            public void set(int index, int value) {
                switch (index){
                    case 0: OilDistillationTrayEntity.this.coreHeat = value; break;
                    case 1: OilDistillationTrayEntity.this.waterHeat = value; break;
                    case 2: OilDistillationTrayEntity.this.active = value; break;
                }
            }
    ...
    public Text getDisplayName() {
        return Text.literal("Oil Distillation Tray");
    }
    ...
    public static void tick(World world, BlockPos blockPos, BlockState blockState, OilDistillationTrayEntity entity) {
    ...
    private static boolean tryFabricTransactions(OilDistillationTrayEntity entity) {
    ...
    private static boolean tryTransactions(OilDistillationTrayEntity entity){
    ...
    private static void sendFluidUpdate(OilDistillationTrayEntity entity){
