...
public class AmmoniaSynthesizerBlock extends BlockWithEntity implements IModID, BlockEntityProvider {
    ...
    public AmmoniaSynthesizerBlock() {
        super(Settings.create()
                ...
                .registryKey(RegistryKey.of(RegistryKeys.BLOCK, Identifier.of(modid,"ammonia_synthesizer")))
        );
        this.setDefaultState(this.stateManager.getDefaultState().with(FACING, Direction.NORTH));
    }
    public AmmoniaSynthesizerBlock(Settings settings) {
        super(settings);
        this.setDefaultState(this.stateManager.getDefaultState().with(FACING, Direction.NORTH));
    }
    ...
    protected MapCodec<? extends BlockWithEntity> getCodec() {
        return createCodec(AmmoniaSynthesizerBlock::new);
    }
