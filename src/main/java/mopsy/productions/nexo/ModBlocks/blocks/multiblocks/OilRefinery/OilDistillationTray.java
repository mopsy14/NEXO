package mopsy.productions.nexo.ModBlocks.blocks.multiblocks.OilRefinery;
...
public class OilDistillationTray extends Block implements IModID {
    @Override
    public String getID(){return "distillation_tray";}
    public static final DirectionProperty FACING;
    public OilDistillationTray() {
