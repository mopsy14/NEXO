package mopsy.productions.nucleartech.screen.ammoniaSynth;
...
public class AmmoniaSynthesiserScreen extends HandledScreen<AmmoniaSynthesiserScreenHandler>{
    ...
    public AmmoniaSynthesiserScreen(AmmoniaSynthesiserScreenHandler handler, PlayerInventory inventory, Text title) {
